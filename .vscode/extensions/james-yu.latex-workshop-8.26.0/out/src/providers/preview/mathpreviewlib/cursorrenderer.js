...
class CursorRenderer {
    ...
    isInText(findResult) {
        let parent = findResult === null || findResult === void 0 ? void 0 : findResult.parent;
        while (parent) {
    ...
    async insertCursor(texMath, cursorPos, cursor) {
        ...
        const cursorNode = findResult === null || findResult === void 0 ? void 0 : findResult.node;
    ...
    async renderCursor(document, texMath, thisColor) {
        ...
        const cursorPos = (_a = vscode.window.activeTextEditor) === null || _a === void 0 ? void 0 : _a.selection.active;
