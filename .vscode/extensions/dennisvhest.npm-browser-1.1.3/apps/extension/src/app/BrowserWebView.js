...
var BrowserWebView = /** @class */ (function () {
    ...
    BrowserWebView.replaceTag = function (tag) {
        return BrowserWebView.tagsToReplace[tag] || tag;
    };
    BrowserWebView.escapeHTML = function (str) {
        return str.replace(/[&<>]/g, this.replaceTag);
    };
    BrowserWebView.escapePackageJsonHtml = function (workspaceState) {
        var packageJsons = [workspaceState.selectedPackageJson].concat(workspaceState.packageJsons);
